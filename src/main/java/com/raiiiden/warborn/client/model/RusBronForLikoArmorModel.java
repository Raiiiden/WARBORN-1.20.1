...
public class RusBronForLikoArmorModel extends DefaultedItemGeoModel<WarbornArmorItem> {
    public RusBronForLikoArmorModel() {
        super(new ResourceLocation(WARBORN.MODID, "armor/rus_bron_for_liko"));
    }
