...
public class RusBronShturmovikArmorModel extends DefaultedItemGeoModel<WarbornArmorItem> {
    public RusBronShturmovikArmorModel() {
        super(new ResourceLocation(WARBORN.MODID, "armor/rus_bron_shturmovik"));
    }
