...
public class WarbornSyringeRenderer extends GeoItemRenderer<SyringeItem> {
    ...
    private static final String NBT_USING = "using";
    private final Set<String> hiddenBones = new HashSet<>();
    public ItemDisplayContext transformType;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    protected SyringeItem animatable;

    public WarbornSyringeRenderer() {
        super(new WarbornSyringeModel());
    }
    ...
    @Override
    public RenderType getRenderType(SyringeItem anim, ResourceLocation tex,
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext ctx, PoseStack pose,
        ...
        if (ctx.firstPerson()) {
            ...
            if (stack.getTag() == null || !stack.getTag().contains(NBT_USING)) {
                stack.getOrCreateTag().putBoolean(NBT_USING, true);
            }
        }
    ...
    @Override
    public void actuallyRender(PoseStack pose, SyringeItem anim, BakedGeoModel model,
    ...
    @Override
    public void renderRecursively(PoseStack stack, SyringeItem anim, GeoBone bone,
                                  RenderType type, MultiBufferSource buf, VertexConsumer vc,
    ...
    @Override
    public ResourceLocation getTextureLocation(SyringeItem inst) {
